...
- [`MemoryStore`](https://github.com/marcjazz/authkestra/tree/0.1.2/authkestra-session/src/memory.rs): A simple in-memory implementation.
- [`RedisStore`](https://github.com/marcjazz/authkestra/tree/0.1.2/authkestra-session/src/redis.rs): An implementation using Redis with automatic expiration.
- [`SqlStore`](https://github.com/marcjazz/authkestra/tree/0.1.2/authkestra-session/src/sql.rs): A persistent implementation for SQL databases using `sqlx`.
