...
For a complete working implementation, check out the [actix_credentials.rs](https://github.com/marcjazz/authkestra/blob/main/authkestra-examples/src/bin/actix_credentials.rs) example in our GitHub repository.
