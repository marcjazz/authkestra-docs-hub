...
For a complete working example featuring multiple providers and session management, see the [axum_oauth.rs](https://github.com/mscatena/authkestra/blob/main/authkestra-examples/src/bin/axum_oauth.rs) file in the `authkestra-examples` directory on GitHub.
