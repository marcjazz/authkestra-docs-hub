---
title: Identity
description: The Identity struct is the unified representation of an authenticated user in Authkestra.
---

The `Identity` struct is the unified representation of an 
