...
For a full implementation example, including error handling and async integration, see the [`offline_validation.rs`](https://github.com/marcjazz/authkestra/blob/main/authkestra-examples/src/bin/offline_validation.rs) file in the `authkestra-examples` crate on GitHub.
