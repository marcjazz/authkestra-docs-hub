...
For a complete working implementation including environment variable handling and multiple providers, check out the [axum_oauth.rs](https://github.com/authkestra/authkestra/blob/main/authkestra-examples/src/bin/axum_oauth.rs) example in the repository.
