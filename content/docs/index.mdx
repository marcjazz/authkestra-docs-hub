---
title: Introduction
description: Authkestra is a modular, framework-agnostic authentication orchestration system for Rust.
---
...
of being **explicit and type-safe**. Authentication context is never 
