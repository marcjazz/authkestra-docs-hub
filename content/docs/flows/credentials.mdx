...
- [Actix-web Credentials Example](https://github.com/marcjazz/authkestra/tree/0.1.1/authkestra-examples/src/bin/actix_credentials.rs)
- [Axum Credentials Example](https://github.com/marcjazz/authkestra/tree/0.1.1/authkestra-examples/src/bin/axum_credentials.rs)
