...
- [Axum OAuth2 Example](https://github.com/marcjazz/authkestra/tree/0.1.2/authkestra-examples/src/bin/axum_oauth.rs)
- [Actix-web GitHub Example](https://github.com/marcjazz/authkestra/tree/0.1.2/authkestra-examples/src/bin/actix_github.rs)
